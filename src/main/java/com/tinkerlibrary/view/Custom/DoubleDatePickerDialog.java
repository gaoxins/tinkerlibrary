...
/**
 * Created by gaoxin on 2017/3/17.
 * 显示开始时间和结束日期类
 */
...
public class DoubleDatePickerDialog extends AlertDialog implements DialogInterface.OnClickListener, DatePicker.OnDateChangedListener {
    ...
    public interface OnDateSetListener {
         ...
         * @param endDayOfMonth
         */
       /* void onDateSet(DatePicker startDatePicker, int startYear, int startMonthOfYear, int startDayOfMonth,int startDayOfHour,int startDayOfMinute
                       DatePicker endDatePicker, int endYear, int endMonthOfYear, int endDayOfMonth,int endDayOfHour,int endDayOfMinute);*/
    ...
    private void tryNotifyDateSet() {
        if (mCallBack != null) {
            ...
            mCallBack.onDateSet(
                    mDatePicker_start, mDatePicker_start.getYear(), mDatePicker_start.getMonth(),mDatePicker_start.getDayOfMonth(),
